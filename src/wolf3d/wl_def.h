...
#ifdef GAMEVER_NOAH3D
#define COMPAT_OBJ_CONVERSION_SIZE 56
#else
#define COMPAT_OBJ_CONVERSION_SIZE 60
#endif

#define COMPAT_OBJ_CONVERT_OBJ_PTR_TO_DOS_PTR(objptr) ((objptr)?((id0_word_t)((id0_word_t)((objptr)-objlist)*COMPAT_OBJ_CONVERSION_SIZE+refkeen_compat_wl_play_objoffset)):(id0_word_t)0)
#define COMPAT_OBJ_CONVERT_DOS_PTR_TO_OBJ_PTR(dosptr) ((dosptr)?(objlist+(id0_word_t)((id0_word_t)(dosptr)-refkeen_compat_wl_play_objoffset)/COMPAT_OBJ_CONVERSION_SIZE):NULL)

extern id0_word_t refkeen_compat_wl_play_objoffset;

// (REFKEEN) Similarly support writing laststatobj to saved game

#define COMPAT_STATOBJ_CONVERSION_SIZE 8

#define COMPAT_STATOBJ_CONVERT_OBJ_PTR_TO_DOS_PTR(objptr) ((objptr)?((id0_word_t)((id0_word_t)((objptr)-statobjlist)*COMPAT_STATOBJ_CONVERSION_SIZE+refkeen_compat_wl_act1_statobjoffset)):(id0_word_t)0)
#define COMPAT_STATOBJ_CONVERT_DOS_PTR_TO_OBJ_PTR(dosptr) ((dosptr)?(statobjlist+(id0_word_t)((id0_word_t)(dosptr)-refkeen_compat_wl_act1_statobjoffset)/COMPAT_STATOBJ_CONVERSION_SIZE):NULL)
